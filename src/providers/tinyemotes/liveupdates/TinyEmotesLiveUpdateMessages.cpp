...
TinyELiveUpdateEmoteUpdateAddMessage::TinyELiveUpdateEmoteUpdateAddMessage(
...
bool TinyELiveUpdateEmoteUpdateAddMessage::validate() const
{
...
TinyELiveUpdateEmoteRemoveMessage::TinyELiveUpdateEmoteRemoveMessage(
    const QJsonObject &json)
    : channelID(json["channel"].toString())
...
bool TinyELiveUpdateEmoteRemoveMessage::validate() const
{
